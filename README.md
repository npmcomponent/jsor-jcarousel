*This repository is a mirror of the [component](http://component.io) module [jsor/jcarousel](http://github.com/jsor/jcarousel). It has been modified to work with NPM+Browserify. You can install it using the command `npm install npmcomponent/jsor-jcarousel`. Please do not open issues or send pull requests against this repo. If you have issues with this repo, report it to [npmcomponent](https://github.com/airportyh/npmcomponent).*
